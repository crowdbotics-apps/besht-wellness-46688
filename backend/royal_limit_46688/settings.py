"""
Django settings for royal_limit_46688 project.
...
ROOT_URLCONF = 'royal_limit_46688.urls'
...
WSGI_APPLICATION = 'royal_limit_46688.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_limit_46688 API",
    "DESCRIPTION": "API documentation for royal_limit_46688 App",
    "VERSION": "v1",
}
